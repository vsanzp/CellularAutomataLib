...
model Epidemics50
  ...
  OutputRegion S(
    XFromRange={1,50},
    YFromRange={1,50},
    Output_type=4,                output_rate = 1, redeclare function ExtOutput =         ExtOutputS)
                                                                                                                            annotation (
    Placement(transformation(extent = {{40, 30}, {60, 50}})));
  OutputRegion I(
    XFromRange={1,50},
    YFromRange={1,50},
    Output_type=4,                output_rate = 1, redeclare function ExtOutput =         ExtOutputI)
                                                                                                                            annotation (
    Placement(transformation(extent = {{40, 12}, {60, 32}})));
  OutputRegion R(
    XFromRange={1,50},
    YFromRange={1,50},
    Output_type=4,                output_rate = 1, redeclare function ExtOutput =         ExtOutputR)
                                                                                                                            annotation (
