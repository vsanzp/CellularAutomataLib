within CellularAutomataLib.Components.ExternalObj;
class CS "External object used to manage the cellular space"
  extends ExternalObject;

  function constructor "CS constructor function"
...
<p>CS constructor function</p>
  ...
  function destructor "CS destructor function"
    input CS s;
